...
const hasInfra = Boolean(process.env.TEST_DATABASE_URL && process.env.TEST_REDIS_URL);

if (!hasInfra) {
  test('booking HTTP tests require TEST_DATABASE_URL and TEST_REDIS_URL', { skip: true }, () => {});
} else {
