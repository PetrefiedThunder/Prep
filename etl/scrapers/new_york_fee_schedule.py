"""Fee schedule validation for New York City scraper outputs."""

from __future__ import annotations

from typing import Any, Iterable

from apps.city_regulatory_service.src.adapters import NewYorkCityAdapter


def _collect_requirements() -> Iterable[dict[str, Any]]:
    """Return all New York City regulatory requirements."""

    return NewYorkCityAdapter.get_all_requirements()


def validate_fee_schedule_new_york() -> dict[str, Any]:
    """Validate New York City fee schedules extracted by the scraper."""
    ...
    for requirement in requirements:
        ...
        tiers_expected = any(
            keyword in schedule.lower() for keyword in ("variable", "per seat", "tier")
        )
...
__all__ = ["validate_fee_schedule_new_york"]
