...
SCENARIOS = [
    # --- SAN FRANCISCO (12) ---
    {
        ...
        "maker": {
            "coi": {
                "general": 1_000_000,
                "aggregate": 2_000_000,
                "ai": "City and County of San Francisco",
            }
        },
        "kitchen": {
            "permits": ["shared_kitchen", "fire", "ventilation"],
            "zoning": {"code": "NC-3", "notice_doc": True},
        },
        "booking": {
            "start": "2025-11-05T10:00:00-08:00",
            "end": "2025-11-05T13:00:00-08:00",
    ...
    },
    {
        ...
        "kitchen": {
            "permits": ["fire", "ventilation"],
            "zoning": {"code": "M-1", "notice_doc": False},
        },
        "booking": {
            "start": "2025-11-05T10:00:00-08:00",
            "end": "2025-11-05T12:00:00-08:00",
    ...
    },
    {
        ...
        "kitchen": {
            "permits": ["shared_kitchen", "fire", "ventilation"],
            "zoning": {"code": "PDR-1-D", "notice_doc": False},
        },
        "booking": {
            "start": "2025-11-05T09:00:00-08:00",
            "end": "2025-11-05T12:00:00-08:00",
            "product_type": "baked_goods",
        },
    ...
    },
    {
        ...
        "booking": {
            "start": "2025-11-05T22:30:00-08:00",
            "end": "2025-11-05T23:30:00-08:00",
            "product_type": "meal_prep",
        },
    ...
    },
    {
        ...
        "kitchen": {
            "permits": ["shared_kitchen", "fire", "ventilation"],
            "zoning": {"code": "NC-3", "notice_doc": True},
            "hours_booked_today": 10,
        },
        "booking": {
            "start": "2025-11-05T12:00:00-08:00",
            "end": "2025-11-05T15:00:00-08:00",
            "product_type": "baked_goods",
        },
    ...
    },
    {
        ...
        "kitchen": {
            ...
            "zoning": {"code": "NC-3", "notice_doc": True},
            "inspection": {
                "start": "2025-11-05T11:00:00-08:00",
                "end": "2025-11-05T12:00:00-08:00",
            },
        },
        "booking": {
            "start": "2025-11-05T10:30:00-08:00",
            "end": "2025-11-05T12:30:00-08:00",
            "product_type": "baked_goods",
        },
    ...
    },
    {
        ...
        "kitchen": {
            "permits": ["shared_kitchen", "ventilation"],
            "zoning": {"code": "NC-3", "notice_doc": True},
        },
        "booking": {
            "start": "2025-11-05T10:00:00-08:00",
    ...
    },
    {
        ...
        "booking": {
            "start": "2025-11-05T05:30:00-08:00",
            "end": "2025-11-05T07:00:00-08:00",
            "product_type": "meal_prep",
        },
        "expect": {"verdict": "DENY", "reasons": ["sound.quiet_hours"]},
    },
    # --- PORTLAND (12) ---
    {
        ...
        "maker": {
            "coi": {
                "general": 1_000_000,
                "aggregate": 2_000_000,
                "ai": "City of Portland and Multnomah County",
            }
        },
        "kitchen": {"permits": ["commissary", "fire", "ventilation"], "community_notice_doc": True},
        "booking": {
            "start": "2025-11-06T09:00:00-08:00",
            "end": "2025-11-06T12:00:00-08:00",
            "product_type": "baked_goods",
        },
        "expect": {"verdict": "ALLOW", "reasons": []},
    },
    {
        ...
        "kitchen": {
            "permits": ["commissary", "fire", "ventilation"],
            "community_notice_doc": False,
        },
        "booking": {
            "start": "2025-11-06T09:00:00-08:00",
            "end": "2025-11-06T12:00:00-08:00",
    ...
    },
    {
        ...
        "kitchen": {
            "permits": ["commissary", "fire", "ventilation"],
            "inspection": {
                "start": "2025-11-06T10:30:00-08:00",
                "end": "2025-11-06T11:30:00-08:00",
            },
        },
        "booking": {
            "start": "2025-11-06T10:00:00-08:00",
            "end": "2025-11-06T12:00:00-08:00",
            "product_type": "baked_goods",
        },
        "expect": {"verdict": "DENY", "reasons": ["calendar.inspection.conflict"]},
    ...
    },
    {
        ...
        "kitchen": {"permits": ["commissary", "fire", "ventilation"], "community_notice_doc": True},
        "booking": {
            "start": "2025-11-06T22:15:00-08:00",
            "end": "2025-11-06T23:15:00-08:00",
            "product_type": "baked_goods",
        },
        "expect": {"verdict": "DENY", "reasons": ["sound.quiet_hours"]},
    },
    {
        ...
        "kitchen": {
            ...
            "community_notice_doc": True,
            "maintenance": {
                "start": "2025-11-06T12:10:00-08:00",
                "end": "2025-11-06T13:10:00-08:00",
            },
        },
        "booking": {
            "start": "2025-11-06T09:00:00-08:00",
        ...
        "expect": {
            ...
            "reasons": ["calendar.maintenance.buffer_required"],
        },
    },
    {
    ...
    },
    {
        ...
        "kitchen": {"permits": ["commissary", "fire", "ventilation"], "community_notice_doc": True},
        "booking": {
            "start": "2025-11-06T05:30:00-08:00",
            "end": "2025-11-06T07:00:00-08:00",
            "product_type": "baked_goods",
        },
        "expect": {"verdict": "DENY", "reasons": ["sound.quiet_hours"]},
    },
    # --- SEATTLE (12) ---
    {
        ...
        "maker": {
            "coi": {
                "general": 1_000_000,
                "aggregate": 2_000_000,
                "ai": "City of Seattle and King County",
            }
        },
        "kitchen": {"permits": ["TFE", "commissary", "fire", "ventilation"]},
        "booking": {
            "start": "2025-11-07T10:00:00-08:00",
            "end": "2025-11-07T12:00:00-08:00",
            "product_type": "meal_prep",
        },
        "expect": {"verdict": "ALLOW", "reasons": []},
    },
    ...
    },
    {
        ...
        "expect": {
            "verdict": "ALLOW_WITH_CONDITIONS",
            "reasons": ["fees.lodging.assessed", "fees.bo.assessed"],
        },
    },
    {
        ...
        "kitchen": {"permits": ["TFE", "commissary", "fire", "ventilation"]},
        "booking": {
            "start": "2025-11-07T22:30:00-08:00",
            "end": "2025-11-07T23:30:00-08:00",
            "product_type": "meal_prep",
        },
        "expect": {"verdict": "DENY", "reasons": ["sound.quiet_hours"]},
    },
    ...
    },
    {
        ...
        "kitchen": {"permits": ["TFE", "commissary", "fire", "ventilation"]},
        "booking": {
            "start": "2025-12-20T10:00:00-08:00",
            "end": "2025-12-20T12:00:00-08:00",
            "product_type": "outdoor_cooking",
        },
    ...
    },
    {
        ...
        "kitchen": {
            "permits": ["TFE", "commissary", "fire", "ventilation"],
    ...
    },
    {
        ...
        "kitchen": {
            "permits": ["TFE", "commissary", "fire", "ventilation"],
            "maintenance": {
                "start": "2025-11-07T11:00:00-08:00",
                "end": "2025-11-07T12:00:00-08:00",
            },
        },
        "booking": {
            "start": "2025-11-07T10:30:00-08:00",
            "end": "2025-11-07T12:30:00-08:00",
            "product_type": "baked_goods",
        },
    ...
    },
    {
        ...
        "kitchen": {"permits": ["TFE", "commissary", "fire", "ventilation"]},
        "booking": {
            "start": "2025-11-07T06:30:00-08:00",
            "end": "2025-11-07T08:00:00-08:00",
            "product_type": "meal_prep",
        },
        "expect": {"verdict": "DENY", "reasons": ["sound.quiet_hours"]},
    },
